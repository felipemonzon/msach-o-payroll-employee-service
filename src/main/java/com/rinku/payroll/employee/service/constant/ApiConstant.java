...
public abstract class ApiConstant {
  ...
  /**
   * Constante para el espacio.
   */
  public static final String SPACE_STRING = " ";
  /**
   * Constante para excepcion.
   */
   ...
   */
  public static final String API_OPERATION_DELIVERY_RETRIEVE =
   ...
   * Operacion para consultar todas las entregas de los empleados.
   */
  public static final String API_OPERATION_DELIVERY_SAVE =
      "Registar las entregas diarias de un empleado.";
  /**
   * Etiqueta para consultar todas las entregas de los empleados.
   */
  public static final String API_TAG_DELIVERY_SAVE = "employee-delivery-save";
  /**
   * Operacion para consultar un empleado.
   */
  public static final String API_OPERATION_EMPLOYEE_SEARCH = "Consulta los daros de un empleado.";
  /**
